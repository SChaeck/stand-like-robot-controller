...
def generate_robot_path(
    ...
    path.extend([
        ...
        },
        {
            "id": 5.2,
            "type": "move",
            "pos": [(l2-9) * np.cos(theta2), (l2-9) * np.sin(theta2), 17+object2_offset], # [temp] 8 + `1`(충분히 열기 위한 추가 힘)
            "rot": 0,
            "time": 0.25,
            "use_cartesian_interpolation": True
        },
        {
            "id": 5.3,
            "type": "move",
            "pos": [(l2-(8+3)) * np.cos(theta2), (l2-(8+3)) * np.sin(theta2), 17+object2_offset], # [temp] 8 + `1`(충분히 열기 위한 추가 힘)
            "rot": 0,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        {
            "id": 6,
            "type": "move",
            "pos": [(l2-(8+3)) * np.cos(theta2), (l2-(8+3)) * np.sin(theta2), 22+object2_offset], # [temp] 8 + `1`(충분히 열기 위한 추가 힘)
            "rot": 0,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
    ...
    path.extend([
        {
            ...
            "rot": 90 + np.rad2deg(np.arctan(4/(l2-1.5))),
            "time": time_to_go
        },
        {
            "id": 14,
    ...
    path.extend([
        ...
        },
        {
            "id": 20,
            "type": "move",
            "pos": [(l1+3.75) * np.cos(theta1), (l1+3.75) * np.sin(theta1), 33+object1_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        }
    ...
    path.extend([
        {
            "id": 25,
            "type": "move",
            "pos": [(l1+7) * np.cos(theta1), (l1+7) * np.sin(theta1), 32.5+object1_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 26,
            "type": "move",
            "pos": [(l1+7) * np.cos(theta1), (l1+7) * np.sin(theta1), 29+object1_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
    ...
    path.extend([
        {
            "id": 34.1,
            "type": "move",
            "pos": [(l2-13) * np.cos(theta2), (l2-13) * np.sin(theta2), 22+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 34.2,
            "type": "move",
            "pos": [(l2-11) * np.cos(theta2), (l2-11) * np.sin(theta2), 22+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 35.1,
            "type": "move",
            "pos": [(l2-9) * np.cos(theta2), (l2-9) * np.sin(theta2), 18+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
    ...
    path.extend([
        {
            "id": 38,
            "type": "move",
            "pos": [(l1) * np.cos(theta1), (l1) * np.sin(theta1), 28.5+object1_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
        ...
        },
        {
            "id": 40,
            "type": "move",
            "pos": [(l1+4.5) * np.cos(theta1), (l1+4.5) * np.sin(theta1), 26.5+object1_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
        ...
        },
        {
            "id": 42,
            "type": "move",
            "pos": [(l1+4) * np.cos(theta1), (l1+4) * np.sin(theta1), 30.5+object1_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        {
            "id": 43,
            "type": "move",
            "pos": [(l2+4.8) * np.cos(theta2), (l2+4.8) * np.sin(theta2), 22.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 44,
            "type": "move",
            "pos": [(l2+6.8) * np.cos(theta2), (l2+6.8) * np.sin(theta2), 22.5+object2_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        ...
        },
        {
            "id": 46,
            "type": "move",
            "pos": [(l2+7) * np.cos(theta2), (l2+7) * np.sin(theta2), 27+object2_offset],
            "rot": 90,
            "time": time_to_go
        }
    ])
    ...
    path.extend([
        ...
        },
        {
            "id": 48,
            "type": "move",
            "pos": [(l1+6.5) * np.cos(theta1), (l1+6.5) * np.sin(theta1), 26.5+object1_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
        ...
        },
        {
            "id": 50,
            "type": "move",
            "pos": [(l1+5.5) * np.cos(theta1), (l1+5.5) * np.sin(theta1), 30.5+object1_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        {
            "id": 51,
            "type": "move",
            "pos": [(l2+2.3) * np.cos(theta2), (l2+2.3) * np.sin(theta2), 22.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 52,
            "type": "move",
            "pos": [(l2+4.3) * np.cos(theta2), (l2+4.3) * np.sin(theta2), 22.5+object2_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
    ...
    path.extend([
        ...
        },
        {
            "id": 56,
            "type": "move",
            "pos": [(l1+9) * np.cos(theta1), (l1+9) * np.sin(theta1), 26.5+object1_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
        ...
        },
        {
            "id": 58,
            "type": "move",
            "pos": [(l1+9) * np.cos(theta1), (l1+9) * np.sin(theta1), 30.5+object1_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        {
            "id": 59,
            "type": "move",
            "pos": [(l2+0.1) * np.cos(theta2), (l2+0.1) * np.sin(theta2), 22.25+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 60,
            "type": "move",
            "pos": [(l2+1.6) * np.cos(theta2), (l2+1.6) * np.sin(theta2), 22.25+object2_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        ...
        },  
        {
            "id": 62,
            "type": "move",
            "pos": [(l2+1.6) * np.cos(theta2), (l2+1.6) * np.sin(theta2), 27+object2_offset],
            "rot": 90,
            "time": time_to_go
        }
    ])
    ...
    path.extend([
        {
            "id": 63,
            "type": "move",
            "pos": [(l1+2.75) * np.cos(theta1), (l1+2.75) * np.sin(theta1), 27.5+object1_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 64,
            "type": "move",
            "pos": [(l1+2.75) * np.cos(theta1), (l1+2.75) * np.sin(theta1), 24+object1_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
        ...
        },
        {
            "id": 66,
            "type": "move",
            "pos": [(l1+1.25) * np.cos(theta1), (l1+1.25) * np.sin(theta1), 27.5+object1_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        {
            "id": 67,
            "type": "move",
            "pos": [(l2+5.2) * np.cos(theta2), (l2+5.2) * np.sin(theta2), 28.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 68,
            "type": "move",
            "pos": [(l2+5.2) * np.cos(theta2), (l2+5.2) * np.sin(theta2), 24.5+object2_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        ...
        },
        {
            "id": 70,
            "type": "move",
            "pos": [(l2+5.7) * np.cos(theta2), (l2+5.7) * np.sin(theta2), 28.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        }
    ])
    ...
    path.extend([
        ...
        },
        {
            "id": 75,
            "type": "move",
            "pos": [(l2+1.8) * np.cos(theta2), (l2+1.8) * np.sin(theta2), 26.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 76,
            "type": "move",
            "pos": [(l2+2.2) * np.cos(theta2), (l2+2.2) * np.sin(theta2), 24.65+object2_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        ...
        },
        {
            "id": 78,
            "type": "move",
            "pos": [(l2+3.1) * np.cos(theta2), (l2+3.1) * np.sin(theta2), 28.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        }
    ])
    ...
    path.extend([
        ...
        },
        {
            "id": 83,
            "type": "move",
            "pos": [(l2+3) * np.cos(theta2), (l2+3) * np.sin(theta2), 29.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 84,
            "type": "move",
            "pos": [(l2+3) * np.cos(theta2), (l2+3) * np.sin(theta2), 27.25+object2_offset],
            "rot": 90,
            "time": time_to_go,
            "use_cartesian_interpolation": True
        },
        ...
        },
        {
            "id": 84,
            "type": "move",
            "pos": [(l2+3.4) * np.cos(theta2), (l2+3.4) * np.sin(theta2), 29.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
        {
            "id": 84.1,
            "type": "move",
            "pos": [(l2+4.4), 0, 29.5+object2_offset],
            "rot": 90,
            "time": time_to_go
        },
    ])
